...
def run_eval(model_name, gen_dir, n: int):
    """
...
# Evaluate Model A & B
# ----------------------------------------------------
fid_a, is_a_mean, is_a_std = run_eval("Model A (Milestone 1)", MODEL_A_DIR, n=N)
fid_b, is_b_mean, is_b_std = run_eval("Model B (Milestone 2)", MODEL_B_DIR, n=N)
